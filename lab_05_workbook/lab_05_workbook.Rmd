...
# Write the answer in a comment
# Q: What was the average number of cases per county in each state? Which state had the lowest average?
# A: 1907.148 was the average per county, Vermont had the lowest average.
...
```{r}
#Q: what was the average number of counties per state?

#writing object and code:
average_county_states <- covid_county %>%
  group_by(state) %>%
  summarise(counties_per_state= n()) %>%
  arrange(total_counties)

average_county_states
