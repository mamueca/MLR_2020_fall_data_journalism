...
```{r}
covid_virgina_august_case_rate <- covid_county_august_case_rate %>%   
...
-30-
```{r}
covid_florida_june_aug_pct_change <- covid_county_monthly_case_rate %>%  select(county, state, d_2020_06_30, d_2020_08_30) %>%  filter(state == "Florida") %>%  mutate(jun_aug_pct_change = (d_2020_08_30 - d_2020_06_30)/d_2020_06_30*100) %>%  arrange(jun_aug_pct_change)

#liberty county had the smallest percent change in Florida, about 95%.
```
