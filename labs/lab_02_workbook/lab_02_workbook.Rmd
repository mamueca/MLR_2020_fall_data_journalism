...
```{r}
arcos_md_baltimore_city_24510_pharmacy <- read_csv("data/arcos-md-baltimore-city-24510-pharmacy.csv")
```
...
```{r}
glimpse(arcos_md_baltimore_city_24510_pharmacy )
```
...
```{r}
arcos_md_baltimore_city_24510_pharmacy
```
...
```{r}
arcos_md_baltimore_city_pharmacies <-arcos_md_baltimore_city_24510_pharmacy %>% select (buyer_name)
...
```{r}
arcos_md_baltimorecity_trimmed <-arcos_md_baltimore_city_24510_pharmacy %>% select(buyer_name, buyer_dea_no, buyer_city, total_dosage_unit, total_records)
...
```{r}
arcos_wv_mingo_sorted <- arcos_wv_mingo_trimmed %>% arrange(desc(total_dosage_unit))
...
```{r}
# Answer to question 1: Giant Pharmacy 166 received 10365 shipments
arcos_md_baltimore_city_pharmacies
```
...
```{r}
# Answer to question 2: JAKOBOVITS, JULIAN MD received 4.
arcos_md_baltimore_city_24510_pharmacy
